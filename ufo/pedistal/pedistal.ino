...
void loop() {
  ...
  if(outputValue0 >=120 &&  outputValue1 >=130 && outputValue2 >=128 && outputValue3 <= 100 ) {
  ...
  if(digitalRead(!led23)&&digitalRead(!led35)) {
    if(digitalRead(!led23)&&digitalRead(!led35)&&digitalRead(!led33)){
      if(digitalRead(led23)&&digitalRead(led35)&&digitalRead(led33)&&digitalRead(led37)){
        if(digitalRead(led23)&&digitalRead(led35)&&digitalRead(led33)&&digitalRead(led37)&&digitalRead(led29)){
          if(digitalRead(led23)&&digitalRead(led35)&&digitalRead(led33)&&digitalRead(led37)&&digitalRead(led29)&&digitalRead(led25)){
            if(digitalRead(led23)&&digitalRead(led35)&&digitalRead(led33)&&digitalRead(led37)&&digitalRead(led29)&&digitalRead(led25)&&digitalRead(led31)){
            }
            else {
              ledreset();
            }  
